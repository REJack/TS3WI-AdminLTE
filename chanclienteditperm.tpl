				...
				<form method="post" action="index.php?site=chanclienteditperm&amp;sid={$sid}">
					<table class="table">
						...
						<tr>
							...
							<td><input type="text" name="cldbid" class="form-control" /></td>
						</tr>
					</table>
			...
			<div class="box-body">
				<form method="post" action="index.php?site=chanclienteditperm&amp;sid={$sid}">
					...
					{foreach key=key item=value from=$allperms}
							...
							<td colspan="6" class="no-padding">
								<div style="display:{$display}" id="Lay1">
									<table class="table table-striped">
										...
										<tr>
											<td>&nbsp;</td>
											<td colspan="5">&nbsp;<a href="javascript:Klappen(3)"><i class="mdi mdi-{$disp_pic}-box mdi-lg" title="aus/ein-klappen" id="Pic3"></i></a>&nbsp;{$lang['virtualservermanagement']}</td></tr>
										<tr>
											<td colspan="6" class="no-padding">
						...
						<tr>
							<td colspan="6">&nbsp;<a href="javascript:Klappen(26)"><i class="mdi mdi-{$disp_pic}-box mdi-lg" title="aus/ein-klappen" id="Pic26"></i></a>&nbsp;{$lang['filetransfer']}</td></tr>
						<tr>
							<td colspan="6" class="no-padding">
						...
						{foreach key=key2 item=value2 from=$value.permissions}
							...
							<tr>
								...
								<td style="width: 7%; vertical-align: middle;" class="text-center no-padding">
									<input class="form-control" type='text' maxlength="3" name="perm[{$value2['grantpermid']}][value]" value="{$value2['grant']}" />
