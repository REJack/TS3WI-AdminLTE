				...
				<div class="col-md-6">
						...
						<div class="box-body">
							<div class="table-responsive">
								<table class="table table-striped table-td-no-padding table-vert-mid">
									<tr>
										<th class="col-xs-6 col-sm-6 col-md-6 col-lg-6">{$lang['autostart']}:</th>
										<td>
										{if $serverinfo['virtualserver_autostart'] == 1}
											<span class="text-green">{$lang['yes']}</span>
										{else}
											<span class="text-red">{$lang['no']}</span>
										{/if}
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td class="col-no-white-space">{$serverinfo['virtualserver_welcomemessage']}</td>
									</tr>
									<tr>
										<th>{$lang['version']}:</th>
									...
									<tr>
										...
										{elseif $serverinfo['virtualserver_codec_encryption_mode']==1}
											<span class="text-red">{$lang['codecencryptionmodegoff']}</span>
										{elseif $serverinfo['virtualserver_codec_encryption_mode']==2}
											<span class="text-green">{$lang['codecencryptionmodegon']}</span>
										{/if}
										</td>
									</tr>
									<tr>
					...
					<div class="box box-info" data-name="serverview_host">
						...
						<div class="box-body">
							<table class="table table-striped table-td-no-padding table-vert-mid">
								<tr>
									<th class="col-xs-6 col-sm-6 col-md-6 col-lg-6">{$lang['hostmessage']}:</td>
					...
					<div class="box box-border-olive" data-name="serverview_standardgroups">
						...
						<div class="box-body">
							<table class="table table-striped table-td-no-padding table-vert-mid">
								<tr>
									<th class="col-xs-6 col-sm-6 col-md-6 col-lg-6">{$lang['servergroup']}:</th>
									<td>
					...
					<div class="box box-warning" data-name="serverview_autoban">
						...
						<div class="box-body">
							<table class="table table-striped table-td-no-padding table-vert-mid">
								<tr>
									<th class="col-xs-6 col-sm-6 col-md-6 col-lg-6">{$lang['autobancount']}:</td>
					...
					<div class="box box-danger" data-name="serverview_antiflood">
						...
						<div class="box-body">
							<table class="table table-striped table-td-no-padding table-vert-mid">
								<tr>
									<th class="col-xs-6 col-sm-6 col-md-6 col-lg-6">{$lang['pointstickreduce']}:</td>
					...
					<div class="box box-success" data-name="serverview_transfers">
						...
						<div class="box-body">
							<table class="table table-striped table-td-no-padding table-vert-mid">
								<tr>
									<th class="col-xs-6 col-sm-6 col-md-6 col-lg-6">{$lang['upbandlimit']}:</td>
					...
					<div class="box box-default" data-name="serverview_logs">
						...
						<div class="box-body">
							<table class="table table-striped table-td-no-padding table-vert-mid">
								<tr>
									<th class="col-xs-6 col-sm-6 col-md-6 col-lg-6">{$lang['logclient']}:</td>
									<td>
